...
interface FunctionOperatorResolver : AbstractCouchbaseResolver {
    fun resolve(typeExpression: FunctionOperator<*>): CouchbaseDopeQuery =
        when (typeExpression) {
            is MetaExpression -> {
            ...
            is ContainsTokenLikeExpression ->
                resolve(
                    "CONTAINS_TOKEN_LIKE",
            ...
            is ContainsTokenRegexpExpression ->
                resolve(
            ...
            is DecodeExpression<*, *> -> {
                ...
                val mergedParameters =
                    decodeExpressionDopeQuery.parameters.merge(

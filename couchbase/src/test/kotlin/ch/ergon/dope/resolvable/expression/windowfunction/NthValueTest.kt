...
class NthValueTest : ManagerDependentTest {
    ...
    fun `should support nth value function with reference`() {
        ...
        val expected = NthValueWithReference(expression, offset, nullsModifier, windowReference = windowReference)
    ...
    fun `should support nth value function with reference and number`() {
        ...
        val windowReference = "ref"
        val nullsModifier = RESPECT
        val expected = NthValueWithReference(expression, offset.toDopeType(), nullsModifier, windowReference = windowReference)

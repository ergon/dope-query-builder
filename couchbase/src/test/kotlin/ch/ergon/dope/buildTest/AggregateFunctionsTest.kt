...
import ch.ergon.dope.resolvable.expression.rowscope.aggregate.arrayAggregateWithReference
...
class AggregateFunctionsTest {
    ...
    fun `should support min with a ValidType and arrays of ValidType`() {
        val expected =
            "SELECT MIN(`numberField`), MIN(`stringField`), MIN(`booleanField`), " +
    ...
    fun `should support min all with a ValidType and arrays of ValidType`() {
        val expected =
            "SELECT MIN(ALL `numberField`), MIN(ALL `stringField`), MIN(ALL `booleanField`), " +
    ...
    fun `should support min distinct with a ValidType and arrays of ValidType`() {
        val expected =
            "SELECT MIN(DISTINCT `numberField`), MIN(DISTINCT `stringField`), MIN(DISTINCT `booleanField`), " +
    ...
    fun `should support min as an alias with a ValidType`() {
        val expected =
            "SELECT MIN(`numberField`) AS `number`, MIN(`stringField`) AS `string`, " +
    ...
    fun `should support max with a ValidType`() {
        val expected =
            "SELECT MAX(`numberField`), MAX(`stringField`), MAX(`booleanField`), " +
    ...
    fun `should support max all with a ValidType`() {
        val expected =
            "SELECT MAX(ALL `numberField`), MAX(ALL `stringField`), MAX(ALL `booleanField`), " +
    ...
    fun `should support max distinct with a ValidType`() {
        val expected =
            "SELECT MAX(DISTINCT `numberField`), MAX(DISTINCT `stringField`), MAX(DISTINCT `booleanField`), " +
    ...
    fun `should support max as an alias with a ValidType`() {
        val expected =
            "SELECT MAX(`numberField`) AS `number`, MAX(`stringField`) AS `string`, " +
    ...
    fun `should support count with a ValidType and arrays of ValidType`() {
        val expected =
            "SELECT COUNT(`numberField`), COUNT(`stringField`), COUNT(`booleanField`), " +
    ...
    fun `should support count all with a Field`() {
        val expected =
            "SELECT COUNT(ALL `numberField`), COUNT(ALL `stringField`), " +
    ...
    fun `should support count distinct with a Field`() {
        val expected =
            "SELECT COUNT(DISTINCT `numberField`), COUNT(DISTINCT `stringField`), " +
    ...
    fun `should support count as an alias with a ValidType and arrays of ValidType`() {
        val expected =
            "SELECT COUNT(`numberField`) AS `number`, COUNT(`stringField`) AS `string`, " +
    ...
    fun `should support array_agg with a ValidType`() {
        val expected =
            "SELECT ARRAY_AGG(`numberField`), ARRAY_AGG(`stringField`), ARRAY_AGG(`booleanField`), " +
    ...
    fun `should support array_agg all with a ValidType`() {
        val expected =
            "SELECT ARRAY_AGG(ALL `numberField`), ARRAY_AGG(ALL `stringField`), " +
    ...
    fun `should support array_agg distinct with a ValidType`() {
        val expected =
            "SELECT ARRAY_AGG(DISTINCT `numberField`), ARRAY_AGG(DISTINCT `stringField`), " +
    ...
    fun `should support array_agg as an alias with a ValidType`() {
        val expected =
            "SELECT ARRAY_AGG(`numberField`) AS `number`, ARRAY_AGG(`stringField`) AS `string`, " +

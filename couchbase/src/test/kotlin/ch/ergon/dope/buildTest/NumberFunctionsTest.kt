...
class NumberFunctionsTest : ResolverDependentTest {
    ...
    fun `should support ABS expression`() {
        ...
        val actual = abs(-1).toDopeQuery(resolver).queryString
    ...
    fun `should support ABS expression with number field`() {
        ...
        val actual = abs(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support ACOS expression`() {
        ...
        val actual = acos(-1).toDopeQuery(resolver).queryString
    ...
    fun `should support ACOS expression with number field`() {
        ...
        val actual = acos(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support ASIN expression`() {
        ...
        val actual = asin(-1).toDopeQuery(resolver).queryString
    ...
    fun `should support ASIN expression with number field`() {
        ...
        val actual = asin(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support ATAN expression`() {
        ...
        val actual = atan(-1).toDopeQuery(resolver).queryString
    ...
    fun `should support ATAN expression with number field`() {
        ...
        val actual = atan(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support ATAN2 expression`() {
        ...
        val actual = atan2(1, 0.5).toDopeQuery(resolver).queryString
    ...
    fun `should support ATAN2 expression with number field as divisor`() {
        ...
        val actual = atan2(someNumberField(), 0.5).toDopeQuery(resolver).queryString
    ...
    fun `should support ATAN2 expression with number field as dividend`() {
        ...
        val actual = atan2(0.5, someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support CEIL expression`() {
        ...
        val actual = ceil(3.14).toDopeQuery(resolver).queryString
    ...
    fun `should support CEIL expression with number field`() {
        ...
        val actual = ceil(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support COS expression`() {
        ...
        val actual = cos(-1).toDopeQuery(resolver).queryString
    ...
    fun `should support COS expression with number field`() {
        ...
        val actual = cos(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support DEGREES expression`() {
        ...
        val actual = degrees(-1).toDopeQuery(resolver).queryString
    ...
    fun `should support DEGREES expression with number field`() {
        ...
        val actual = degrees(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support E (euler) expression`() {
        ...
        val actual = e().toDopeQuery(resolver).queryString
    ...
    fun `should support EXP expression`() {
        ...
        val actual = exp(-1).toDopeQuery(resolver).queryString
    ...
    fun `should support EXP expression with number field`() {
        ...
        val actual = exp(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support LN expression`() {
        ...
        val actual = ln(1).toDopeQuery(resolver).queryString
    ...
    fun `should support LN expression with number field`() {
        ...
        val actual = ln(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support LOG expression`() {
        ...
        val actual = log(1).toDopeQuery(resolver).queryString
    ...
    fun `should support LOG expression with number field`() {
        ...
        val actual = log(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support FLOOR expression`() {
        ...
        val actual = floor(3.14).toDopeQuery(resolver).queryString
    ...
    fun `should support FLOOR expression with number field`() {
        ...
        val actual = floor(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support PI expression`() {
        ...
        val actual = pi().toDopeQuery(resolver).queryString
    ...
    fun `should support POWER expression`() {
        ...
        val actual = power(2, 3).toDopeQuery(resolver).queryString
    ...
    fun `should support POWER expression with base as number field`() {
        ...
        val actual = power(someNumberField(), 3).toDopeQuery(resolver).queryString
    ...
    fun `should support POWER expression with exponent as number field`() {
        ...
        val actual = power(3.14, someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support POWER expression with base and exponent as number fields`() {
        ...
        val actual = power(someNumberField(), someNumberField("anotherNumberField")).toDopeQuery(resolver).queryString
    ...
    fun `should support RADIANS expression`() {
        ...
        val actual = radians(180).toDopeQuery(resolver).queryString
    ...
    fun `should support RADIANS expression with number field`() {
        ...
        val actual = radians(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support RANDOM expression`() {
        ...
        val actual = random().toDopeQuery(resolver).queryString
    ...
    fun `should support RANDOM expression with seed`() {
        ...
        val actual = random(1).toDopeQuery(resolver).queryString
    ...
    fun `should support RANDOM expression with number field as seed`() {
        ...
        val actual = random(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support ROUND expression`() {
        ...
        val actual = round(3.14).toDopeQuery(resolver).queryString
    ...
    fun `should support ROUND expression with number field`() {
        ...
        val actual = round(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support ROUND expression with digits`() {
        ...
        val actual = round(3.14, 1).toDopeQuery(resolver).queryString
    ...
    fun `should support ROUND expression with number field and digits`() {
        ...
        val actual = round(someNumberField(), 1).toDopeQuery(resolver).queryString
    ...
    fun `should support ROUND expression with digits as number field`() {
        ...
        val actual = round(3.14, someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support ROUND expression with number field and digits as number fields`() {
        ...
        val actual = round(someNumberField(), someNumberField("anotherNumberField")).toDopeQuery(resolver).queryString
    ...
    fun `should support SIGN expression`() {
        ...
        val actual = sign(-1).toDopeQuery(resolver).queryString
    ...
    fun `should support SIGN expression with number field`() {
        ...
        val actual = sign(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support SIN expression`() {
        ...
        val actual = sin(3.14).toDopeQuery(resolver).queryString
    ...
    fun `should support SIN expression with number field`() {
        ...
        val actual = sin(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support SQRT expression`() {
        ...
        val actual = sqrt(16).toDopeQuery(resolver).queryString
    ...
    fun `should support SQRT expression with number field`() {
        ...
        val actual = sqrt(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support TAN expression`() {
        ...
        val actual = tan(3.14).toDopeQuery(resolver).queryString
    ...
    fun `should support TAN expression with number field`() {
        ...
        val actual = tan(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support TRUNC expression`() {
        ...
        val actual = trunc(3.14).toDopeQuery(resolver).queryString
    ...
    fun `should support TRUNC expression with number field`() {
        ...
        val actual = trunc(someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support TRUNC expression with digits`() {
        ...
        val actual = trunc(3.14, 1).toDopeQuery(resolver).queryString
    ...
    fun `should support TRUNC expression with number field and digits`() {
        ...
        val actual = trunc(someNumberField(), 1).toDopeQuery(resolver).queryString
    ...
    fun `should support TRUNC expression with digits as number field`() {
        ...
        val actual = trunc(3.14, someNumberField()).toDopeQuery(resolver).queryString
    ...
    fun `should support TRUNC expression with number field and digits as number fields`() {
        ...
        val actual = trunc(someNumberField(), someNumberField("anotherNumberField")).toDopeQuery(resolver).queryString

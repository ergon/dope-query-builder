...
class SystemFieldsTest {
    ...
    fun `should select all fields from buckets`() {
        ...
        val expected =
            "SELECT `buckets`.`datastore_id`, `buckets`.`name`, `buckets`.`namespace`, " +
    ...
    fun `should select all fields from scopes`() {
        ...
        val expected =
            "SELECT `scopes`.`bucket`, `scopes`.`datastore_id`, `scopes`.`name`, " +
    ...
    fun `should select all fields from keyspaces`() {
        ...
        val expected =
            "SELECT `keyspaces`.`bucket`, `keyspaces`.`datastore_id`, `keyspaces`.`id`, " +
    ...
    fun `should select all fields from indexes`() {
        ...
        val expected =
            "SELECT `indexes`.`bucket_id`, `indexes`.`condition`, `indexes`.`datastore_id`, " +
    ...
    fun `should select all fields from group_info`() {
        ...
        val expected =
            "SELECT `group_info`.`description`, `group_info`.`id`, " +
    ...
    fun `should select all fields from vitals`() {
        ...
        val expected =
            "SELECT `vitals`.`uptime`, `vitals`.`local.time`, `vitals`.`version`, " +
    ...
    fun `should select all fields from active_requests`() {
        ...
        val expected =
            "SELECT `active_requests`.`clientContextID`, `active_requests`.`cpuTime`, " +
    ...
    fun `should select all fields from prepareds`() {
        ...
        val expected =
            "SELECT `prepareds`.`encoded_plan`, `prepareds`.`featuresControl`, " +
    ...
    fun `should select all fields from completed_requests`() {
        ...
        val expected =
            "SELECT `completed_requests`.`clientContextID`, `completed_requests`.`cpuTime`, " +
    ...
    fun `should select all fields from completed_requests_history`() {
        ...
        val expected =
            "SELECT `completed_requests_history`.`clientContextID`, `completed_requests_history`.`cpuTime`, " +
    ...
    fun `should select all fields from awr`() {
        ...
        val expected =
            "SELECT `awr`.`enabled`, `awr`.`interval`, `awr`.`location`, " +
    ...
    fun `should select all fields from my_user_info`() {
        ...
        val expected =
            "SELECT `my_user_info`.`domain`, `my_user_info`.`external_groups`, " +
    ...
    fun `should select all fields from user_info`() {
        ...
        val expected =
            "SELECT `user_info`.`domain`, `user_info`.`external_groups`, " +
    ...
    fun `should select all fields from applicable_roles`() {
        ...
        val expected =
            "SELECT `applicable_roles`.`bucket_name`, `applicable_roles`.`scope_name`, " +
    ...
    fun `should select all fields from dictionary`() {
        ...
        val expected =
            "SELECT `dictionary`.`avgDocKeySize`, `dictionary`.`avgDocSize`, " +
    ...
    fun `should select all fields from dictionary_cache`() {
        ...
        val expected =
            "SELECT `dictionary_cache`.`avgDocKeySize`, `dictionary_cache`.`avgDocSize`, " +
    ...
    fun `should select all fields from functions_cache`() {
        ...
        val expected =
            "SELECT `functions_cache`.`#language`, `functions_cache`.`avgServiceTime`, " +
    ...
    fun `should select all fields from tasks_cache`() {
        ...
        val expected =
            "SELECT `tasks_cache`.`class`, `tasks_cache`.`delay`, `tasks_cache`.`id`, " +
    ...
    fun `should select all fields from transactions`() {
        ...
        val expected =
            "SELECT `transactions`.`durabilityLevel`, `transactions`.`durabilityTimeout`, " +
    ...
    fun `should select all fields from sequences`() {
        ...
        val expected =
            "SELECT `sequences`.`bucket`, `sequences`.`cache`, `sequences`.`cycle`, " +
    ...
    fun `should select all fields from all_sequences`() {
        ...
        val expected =
            "SELECT `all_sequences`.`bucket`, `all_sequences`.`cache`, `all_sequences`.`cycle`, " +
    ...
    fun `should select all fields from aus`() {
        ...
        val expected =
            "SELECT `aus`.`enable`, `aus`.`schedule`, `aus`.`change_percentage`, " +
    ...
    fun `should select all fields from aus_settings`() {
        ...
        val expected =
            "SELECT `aus_settings`.`enable`, `aus_settings`.`change_percentage`, " +

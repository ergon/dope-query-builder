...
//    import ch.ergon.dope.resolvable.formatSingleWithMultipleStringsToQueryString
//    import ch.ergon.dope.resolvable.formatToQueryStringWithAtLeastOneString
...
//
//            val actual = formatSingleWithMultipleStringsToQueryString(left, right)
//
...
//
//            val actual = formatSingleWithMultipleStringsToQueryString(left, symbol, right)
//
//            assertEquals(expected, actual)
//        }
//
...
//
//            val actual = formatToQueryStringWithAtLeastOneString(symbol, *arguments.)
//
//            assertEquals(expected, actual)
//        }
//

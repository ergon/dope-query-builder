    ...
    fun `use string functions to create a new string`() {
        val dopeQuery = QueryBuilder()
            .select(
                ...
                "2023-10-05".differenceIn("2023-08-05", DateComponent.MONTH).add(3).alias("differenceInDays"),
                "2025-09-09".inArray("2025-08-08".dateRangeBy("2025-10-10", DateComponent.DAY)).alias("inArray"),
            ).build()

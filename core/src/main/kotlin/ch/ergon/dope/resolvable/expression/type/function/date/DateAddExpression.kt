...
class DateAddMillisExpression(date: TypeExpression<NumberType>, increment: TypeExpression<NumberType>, component: ArithmeticComponent) :
    FunctionExpression<NumberType>("DATE_ADD_MILLIS", date, increment, component)

class DateAddStrExpression(date: TypeExpression<StringType>, increment: TypeExpression<NumberType>, component: ArithmeticComponent) :

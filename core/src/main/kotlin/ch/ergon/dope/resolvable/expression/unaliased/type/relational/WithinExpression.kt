...
class WithinExpression<T : ValidType>(
    ...
    override fun toDopeQuery(): DopeQuery {
        ...
        return DopeQuery(
            queryString = "${searchDopeQuery.queryString} WITHIN ${targetDopeQuery.queryString}",
            parameters = searchDopeQuery.parameters + targetDopeQuery.parameters,
        )
    }
}

fun <T : ValidType> TypeExpression<T>.within(target: TypeExpression<ArrayType<T>>) = WithinExpression(this, target)

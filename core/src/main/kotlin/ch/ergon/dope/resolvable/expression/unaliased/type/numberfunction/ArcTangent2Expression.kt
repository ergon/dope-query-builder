...
fun atan2(divisor: TypeExpression<NumberType>, dividend: Number) = atan2(divisor, dividend.toNumberType())
fun atan2(divisor: Number, dividend: TypeExpression<NumberType>) = atan2(divisor.toNumberType(), dividend)
fun atan2(divisor: Number, dividend: Number) = atan2(divisor.toNumberType(), dividend.toNumberType())

...
class VarianceExpression(
    ...
    override fun toDopeQuery(): DopeQuery {
        ...
        return DopeQuery(
            queryString = toFunctionQueryString("VARIANCE", quantifier, numberDopeQuery),
            parameters = numberDopeQuery.parameters,
        )
    }
}

fun variance(number: Field<out NumberType>, quantifier: AggregateQuantifier = ALL) = VarianceExpression(number, quantifier)

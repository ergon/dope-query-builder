...
class DecodeExpression<T : ValidType, U : ValidType>(
    ...
    override fun toDopeQuery(): DopeQuery {
        ...
        val searchResultDopeQuery = getSearchResultDopeQuery(searchResult)
        val searchResultsDopeQuery = searchResults.map { getSearchResultDopeQuery(it) }.toTypedArray()
    ...
    private fun getSearchResultDopeQuery(searchResult: SearchResult<T, out U>): DopeQuery {
        val searchDopeQuery = searchResult.searchExpression.toDopeQuery()
        val resultDopeQuery = searchResult.resultExpression.toDopeQuery()
        return DopeQuery(

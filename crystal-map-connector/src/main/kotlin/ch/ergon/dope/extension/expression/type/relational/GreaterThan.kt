...
@JvmName("isGreaterThanNumber")
fun Number.isGreaterThan(right: CMJsonField<out Number>): GreaterThanExpression<NumberType> = toDopeType().isGreaterThan(right.toDopeType())
...
@JvmName("isGreaterThanNumber")
fun CMJsonField<out Number>.isGreaterThan(right: Number): GreaterThanExpression<NumberType> = toDopeType().isGreaterThan(right.toDopeType())

@JvmName("isGreaterThanNumberConverter")
fun <Convertable : Any, JsonType : Number> CMConverterField<Convertable, JsonType>.isGreaterThan(
    other: Convertable,
): GreaterThanExpression<NumberType> = toDopeType().isGreaterThan(toDopeType(other))

@JvmName("isGreaterThanNumberConverter")
fun <Convertable : Any, JsonType : Number> Convertable.isGreaterThan(
...
@JvmName("isGreaterThanString")
fun TypeExpression<StringType>.isGreaterThan(right: CMJsonField<String>): GreaterThanExpression<StringType> = isGreaterThan(right.toDopeType())

@JvmName("isGreaterThanString")
fun String.isGreaterThan(right: CMJsonField<String>): GreaterThanExpression<StringType> = toDopeType().isGreaterThan(right.toDopeType())

@JvmName("isGreaterThanString")
fun CMJsonField<String>.isGreaterThan(right: TypeExpression<StringType>): GreaterThanExpression<StringType> = toDopeType().isGreaterThan(right)

@JvmName("isGreaterThanString")
fun CMJsonField<String>.isGreaterThan(right: String): GreaterThanExpression<StringType> = toDopeType().isGreaterThan(right.toDopeType())

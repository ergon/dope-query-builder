...
import ch.ergon.dope.extension.expression.type.`object`.addAttribute
import ch.ergon.dope.extension.expression.type.`object`.concat
import ch.ergon.dope.extension.expression.type.`object`.innerPairs
import ch.ergon.dope.extension.expression.type.`object`.length
import ch.ergon.dope.extension.expression.type.`object`.names
import ch.ergon.dope.extension.expression.type.`object`.pairs
import ch.ergon.dope.extension.expression.type.`object`.pairsNested
import ch.ergon.dope.extension.expression.type.`object`.paths
import ch.ergon.dope.extension.expression.type.`object`.putAttribute
import ch.ergon.dope.extension.expression.type.`object`.removeAttribute
import ch.ergon.dope.extension.expression.type.`object`.renameAttribute
import ch.ergon.dope.extension.expression.type.`object`.replace
import ch.ergon.dope.extension.expression.type.`object`.unwrap
import ch.ergon.dope.extension.expression.type.`object`.values
...
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectAddExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectConcatExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectInnerPairsExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectLengthExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectNamesExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectPairsExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectPairsNestedExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectPathsExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectPutExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectRemoveExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectRenameExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectReplaceExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectUnwrapExpression
import ch.ergon.dope.resolvable.expression.type.function.`object`.ObjectValuesExpression

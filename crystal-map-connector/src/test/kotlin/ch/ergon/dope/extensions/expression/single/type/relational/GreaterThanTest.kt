...
import ch.ergon.dope.extension.expression.single.type.relational.isGreaterThan
...
import ch.ergon.dope.resolvable.expression.single.type.relational.GreaterThanExpression
...
class GreaterThanTest : ManagerDependentTest {
    ...
    @Test
    fun `should support greater than with NumberType CMJsonFieldNumber`() {
    ...
    @Test
    fun `should support greater than with StringType CMJsonFieldNumber`() {

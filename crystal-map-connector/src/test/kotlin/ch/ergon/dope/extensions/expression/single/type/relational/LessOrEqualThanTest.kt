...
import ch.ergon.dope.extension.expression.single.type.relational.isLessOrEqualThan
...
import ch.ergon.dope.resolvable.expression.single.type.relational.LessOrEqualThanExpression
...
class LessOrEqualThanTest : ManagerDependentTest {
    ...
    @Test
    fun `should support less or equal than with NumberType CMJsonFieldNumber`() {
    ...
    @Test
    fun `should support less or equal than with StringType CMJsonFieldNumber`() {

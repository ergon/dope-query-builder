...
//        )
//
//        val actual = Dummy("something").numberList.any { it.mod(2).isEqualTo(1) }
//
//        assertEquals(expected, actual)
//    }
//
...
//        )
//
//        val actual = Dummy().stringList.any { upper(it).isEqualTo("some value") }
//
//        assertEquals(expected, actual)
//    }
//
...
//        )
//
//        val actual = Dummy().booleanList.any { it }
//
//        assertEquals(expected, actual)
//    }
//
...
//        )
//
//        val actual = Dummy().numberList.every { it.mod(2).isEqualTo(1) }
//
//        assertEquals(expected, actual)
//    }
//
...
//        )
//
//        val actual = Dummy().stringList.every { upper(it).isEqualTo("some value") }
//
//        assertEquals(expected, actual)
//    }
//
...
//        )
//
//        val actual = Dummy().booleanList.every { it }
//
//        assertEquals(expected, actual)
//    }
//

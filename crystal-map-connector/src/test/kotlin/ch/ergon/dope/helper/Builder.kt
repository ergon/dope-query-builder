...
fun someCMNumberField(
    name: String = "cmNumberField",
    path: String = "",
) = CMJsonField<Number>(name, path)

fun someCMStringField(
    name: String = "cmStringField",
    path: String = "",
) = CMJsonField<String>(name, path)

fun someCMBooleanField(
    name: String = "cmBooleanField",
    path: String = "",
) = CMJsonField<Boolean>(name, path)

fun someCMConverterNumberField(
    name: String = "cmConverterNumberField",
    path: String = "",
) = CMConverterField(name, path, DateNumberConverterInstance)

fun someCMConverterStringField(
    name: String = "cmConverterStringField",
    path: String = "",
) = CMConverterField(name, path, DateStringConverterInstance)

fun someCMConverterBooleanField(
    name: String = "cmConverterBooleanField",
    path: String = "",
) = CMConverterField(name, path, DateBooleanConverterInstance)

fun someCorruptField(
    name: String = "corruptField",
    path: String = "",
) = CMConverterField(name, path, CorruptStringNumberConverterInstance)

fun someNumberFieldList(
    name: String = "numberFieldList",
    bucket: Bucket? = null,
) = Field<ArrayType<NumberType>>(name, bucket)

fun someStringFieldList(
    name: String = "stringFieldList",
    bucket: Bucket? = null,
) = Field<ArrayType<StringType>>(name, bucket)

fun someBooleanFieldList(
    name: String = "booleanFieldList",
    bucket: Bucket? = null,
) = Field<ArrayType<BooleanType>>(name, bucket)

fun someCMNumberList(
    name: String = "cmNumberList",
    path: String = "",
) = CMJsonList<Number>(name, path)

fun someCMStringList(
    name: String = "cmStringList",
    path: String = "",
) = CMJsonList<String>(name, path)

fun someCMBooleanList(
    name: String = "cmBooleanList",
    path: String = "",
) = CMJsonList<Boolean>(name, path)

class SchemaDummy : Schema

fun someCMObjectList(
    name: String = "cmObjectList",
    path: String = "",
) = CMObjectList(SchemaDummy(), name, path)

fun someCMObjectField(
    name: String = "cmObjectField",
    path: String = "",
) = CMObjectField(SchemaDummy(), name, path)

fun someCMConverterNumberList(
    name: String = "cmConverterNumberList",
    path: String = "",
) = CMConverterList(name, path, DateNumberConverterInstance)

fun someCMConverterStringList(
    name: String = "cmConverterStringList",
    path: String = "",
) = CMConverterList(name, path, DateStringConverterInstance)

fun someCMConverterBooleanList(
    name: String = "cmConverterBooleanList",
    path: String = "",
...
fun someFrom(
    fromable: Fromable = someBucket(),
    selectClause: SelectClause = someSelect(),
) = FromClause(fromable, selectClause)
...
fun someNumberField(
    ...
    bucket: Bucket? = null,
) = Field<NumberType>(name, bucket)

fun someStringField(
    name: String = "stringField",
    bucket: Bucket? = null,
) = Field<StringType>(name, bucket)

fun someBooleanField(
    name: String = "booleanField",
    bucket: Bucket? = null,
) = Field<BooleanType>(name, bucket)

fun someObjectField(
    name: String = "objectField",
    bucket: Bucket? = null,
) = Field<ObjectType>(name, bucket)
...
abstract class DateNumberConverter : ITypeConverter<Date, Number> {
    override fun write(value: Date?): Number? = value?.toInstant()?.toEpochMilli()
...
abstract class DateStringConverter : ITypeConverter<Date, String> {
    override fun write(value: Date?): String? = value?.toInstant()?.toEpochMilli().toString()
